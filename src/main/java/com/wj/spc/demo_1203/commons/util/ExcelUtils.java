...
/**
 * Created by liyaoqiang on 2018/10/3.
 */
public class ExcelUtils {
    ...
    public static File writeExcel(String directory, String fileName, String sheetName, List<String> columnNames,
                                  String sheetTitle, List<List<Object>> objects, boolean append, HttpServletResponse response) throws Exception {
        File tmpFile = assertFile(directory, fileName);
        return exportExcel(tmpFile, sheetName, columnNames, sheetTitle, objects, append,response);
    }
     ...
     * @return
     */
    public static Workbook exportExcelForEmail(String sheetName, List<String> columnNames,
                                    String sheetTitle, List<List<Object>> objects, boolean append) {
        // 声明一个工作薄
